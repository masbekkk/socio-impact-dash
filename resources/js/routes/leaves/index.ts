...
/**
* @see \App\Http\Controllers\LeaveController::create_travel
* @see app/Http/Controllers/LeaveController.php:42
* @route '/leaves/create-travel'
*/
export const create_travel = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: create_travel.url(options),
    method: 'get',
})

create_travel.definition = {
    methods: ["get","head"],
...
* @route '/leaves/create-travel'
*/
create_travel.url = (options?: RouteQueryOptions) => {
    return create_travel.definition.url + queryParams(options)
}
...
* @route '/leaves/create-travel'
*/
create_travel.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: create_travel.url(options),
    method: 'get',
})
...
* @route '/leaves/create-travel'
*/
create_travel.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: create_travel.url(options),
    method: 'head',
})
...
* @route '/leaves/create-travel'
*/
const create_travelForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: create_travel.url(options),
    method: 'get',
})
...
* @route '/leaves/create-travel'
*/
create_travelForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: create_travel.url(options),
    method: 'get',
})
...
* @route '/leaves/create-travel'
*/
create_travelForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: create_travel.url({
...
create_travel.form = create_travelForm
...
* @see app/Http/Controllers/LeaveController.php:125
...
* @see app/Http/Controllers/LeaveController.php:134
...
const leaves = {
    create_travel: Object.assign(create_travel, create_travel),
