...
* @see app/Http/Controllers/LetterRequestController.php:27
...
* @see app/Http/Controllers/LetterRequestController.php:42
* @route '/letter-requests'
*/
...
* @see app/Http/Controllers/LetterRequestController.php:34
...
/**
* @see \App\Http\Controllers\LetterRequestController::assign
* @see app/Http/Controllers/LetterRequestController.php:61
* @route '/letter-requests/{letter_request}/assign'
*/
export const assign = (args: { letter_request: string | number } | [letter_request: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/letter-requests/{letter_request}/assign'
*/
assign.url = (args: { letter_request: string | number } | [letter_request: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { letter_request: args }
    }
...
* @route '/letter-requests/{letter_request}/assign'
*/
assign.post = (args: { letter_request: string | number } | [letter_request: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: assign.url(args, options),
    method: 'post',
})
...
* @route '/letter-requests/{letter_request}/assign'
*/
const assignForm = (args: { letter_request: string | number } | [letter_request: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/letter-requests/{letter_request}/assign'
*/
assignForm.post = (args: { letter_request: string | number } | [letter_request: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: assign.url(args, options),
    method: 'post',
})
...
* @see app/Http/Controllers/LetterRequestController.php:78
