...
* @see app/Http/Controllers/Api/V1/UserController.php:22
* @route '/api/v1/users'
*/
...
* @see app/Http/Controllers/Api/V1/UserController.php:74
* @route '/api/v1/users'
*/
...
* @see app/Http/Controllers/Api/V1/UserController.php:101
...
* @see app/Http/Controllers/Api/V1/UserController.php:114
* @route '/api/v1/users/{user}'
*/
...
* @see app/Http/Controllers/Api/V1/UserController.php:146
* @route '/api/v1/users/{user}'
*/
