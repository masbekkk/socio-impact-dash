...
* @see app/Http/Controllers/ReimbursementController.php:231
...
* @see app/Http/Controllers/ReimbursementController.php:23
...
* @see app/Http/Controllers/ReimbursementController.php:239
...
* @see app/Http/Controllers/ReimbursementController.php:247
* @route '/reimbursements'
*/
...
* @see app/Http/Controllers/ReimbursementController.php:255
...
* @see app/Http/Controllers/ReimbursementController.php:296
...
* @see app/Http/Controllers/ReimbursementController.php:463
* @route '/reimbursements/{reimbursement}'
*/
...
* @see app/Http/Controllers/ReimbursementController.php:471
* @route '/reimbursements/{reimbursement}'
*/
...
* @see app/Http/Controllers/ReimbursementController.php:488
...
* @see app/Http/Controllers/ReimbursementController.php:494
...
* @see app/Http/Controllers/ReimbursementController.php:476
...
const ReimbursementController = { createATR, createEER, createAllowance, approvals, index, create, store, show, edit, update, destroy, approve, reject, bulkApprove }
