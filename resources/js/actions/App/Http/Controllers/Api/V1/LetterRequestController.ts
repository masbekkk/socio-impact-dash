...
* @see app/Http/Controllers/Api/V1/LetterRequestController.php:19
...
* @see app/Http/Controllers/Api/V1/LetterRequestController.php:73
* @route '/api/v1/letter-requests'
*/
...
* @see app/Http/Controllers/Api/V1/LetterRequestController.php:59
...
* @see app/Http/Controllers/Api/V1/LetterRequestController.php:109
* @route '/api/v1/letter-requests/{letter_request}'
*/
...
* @see app/Http/Controllers/Api/V1/LetterRequestController.php:168
* @route '/api/v1/letter-requests/{letter_request}'
*/
...
* @see app/Http/Controllers/Api/V1/LetterRequestController.php:186
...
* @see app/Http/Controllers/Api/V1/LetterRequestController.php:208
...
const LetterRequestController = { index, store, show, update, destroy, assignNumber, reject }
