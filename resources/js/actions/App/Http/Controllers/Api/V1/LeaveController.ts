...
* @see app/Http/Controllers/Api/V1/LeaveController.php:156
* @route '/api/v1/leaves/{leaf}'
*/
...
* @see app/Http/Controllers/Api/V1/LeaveController.php:216
* @route '/api/v1/leaves/{leaf}'
*/
...
/**
* @see \App\Http\Controllers\Api\V1\LeaveController::updateStatus
* @see app/Http/Controllers/Api/V1/LeaveController.php:63
* @route '/api/v1/leaves/{code}/status'
*/
export const updateStatus = (args: { code: string | number } | [code: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/api/v1/leaves/{code}/status'
*/
updateStatus.url = (args: { code: string | number } | [code: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { code: args }
    }
...
* @route '/api/v1/leaves/{code}/status'
*/
updateStatus.post = (args: { code: string | number } | [code: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: updateStatus.url(args, options),
    method: 'post',
})
...
* @route '/api/v1/leaves/{code}/status'
*/
const updateStatusForm = (args: { code: string | number } | [code: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/v1/leaves/{code}/status'
*/
updateStatusForm.post = (args: { code: string | number } | [code: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: updateStatus.url(args, options),
    method: 'post',
})
...
const LeaveController = { index, store, show, update, destroy, updateStatus }
