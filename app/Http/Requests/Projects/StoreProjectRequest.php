...
final class StoreProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'termin_payments.*.nomor_surat' => ['nullable', 'string', 'max:255'],
            'termin_payments.*.tertuju' => ['nullable', 'string', 'max:255'],
            'termin_payments.*.billing_file' => ['nullable', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:51200'],
            'termin_payments.*.proof_file' => ['nullable', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:51200'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'termin_payments.*.nomor_surat' => 'Nomor Surat Termin',
            'termin_payments.*.tertuju' => 'Tertuju Termin',
            'termin_payments.*.billing_file' => 'Dokumen Penagihan Termin',
            'termin_payments.*.proof_file' => 'Bukti Pembayaran Termin',
