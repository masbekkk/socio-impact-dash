...
function Create() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("/api/v1/letter-codes", data);
      toast.success("Kode Surat berhasil dibuat.");
      ...
      if (error.response?.status === 422) {
        ...
        toast.error(error.response?.data?.message || "Gagal membuat kode surat.");
      }
    }
  };
  const breadcrumbs = [
  ...
  return /* @__PURE__ */ jsxs(AppSidebarLayout, { breadcrumbs, children: [
    /* @__PURE__ */ jsx(Head, { title: "Add Letter Code" }),
    /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-10 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsx(Button, { variant: "outline", size: "icon", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "/admin/letter-codes", children: /* @__PURE__ */ jsx(ChevronLeft, { className: "h-4 w-4" }) }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Add Letter Code" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Create a new kode surat or department." })
        ] })
      ] }),
      /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Letter Code Details" }) }),
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Unique identifier for the kode suraton." }),
        ...
        /* @__PURE__ */ jsxs(CardFooter, { className: "flex items-center justify-end gap-3 border-t p-6", children: [
          /* @__PURE__ */ jsx(Button, { variant: "outline", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "/admin/letter-codes", children: "Cancel" }) }),
