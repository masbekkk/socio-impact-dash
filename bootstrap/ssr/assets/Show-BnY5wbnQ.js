...
import { A as AppSidebarLayout, g as Avatar, h as AvatarFallback } from "./app-sidebar-layout-5JGZFayF.js";
...
import { Loader2, FileText, ArrowLeft, XCircle, AlertCircle, CheckCircle, DollarSign, Clock, Plus, Calendar, Briefcase, Building2, X, ChevronUp, ChevronDown, Download, CreditCard, Upload, Info, User } from "lucide-react";
import { F as FileUploadDropzone } from "./FileUploadDropzone-Cbnvbv0c.js";
import { r as resubmitReimbursement } from "./reimbursement-service-BqypCIIo.js";
...
function Show() {
  ...
  const handleStartRevisionEdit = () => {
    ...
    setRevisionForm({
      ...
      replacement_pic_id: "",
      // Unfortunately we don't have this in ReimbursementDetail right now, so we start empty.
  ...
  const removeItemEerRevision = (id2) => {
    setRevisionForm((prev) => ({
      ...prev,
      eer_items: prev.eer_items.filter((item) => item.id !== id2)
    }));
  };
  ...
  return /* @__PURE__ */ jsxs(AppSidebarLayout, { breadcrumbs, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs(CardContent, { className: "space-y-8", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
                ...
                data.type === "eer" && data.eer_type && /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "capitalize px-3 border-blue-200 bg-blue-50 text-blue-700", children: data.eer_type }) })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
                ...
                data.amount != null && data.amount > 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-xs font-medium text-muted-foreground uppercase", children: "Total Biaya" }),
              ...
              (data.start_date || data.end_date) && data.type !== "allowance" && /* @__PURE__ */ jsxs("div", { className: "bg-blue-50/50 p-4 rounded-lg border border-blue-100 space-y-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-blue-800 font-medium text-sm", children: [
                  /* @__PURE__ */ jsx(Calendar, { className: "h-4 w-4" }),
                  " ",
                  data.type === "atr" ? "Tanggal Penggunaan Dana" : "Jadwal Penggunaan Dana"
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 text-sm", children: [
                  data.start_date && /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-xs block", children: data.type === "atr" ? "Tanggal Penggunaan" : "Tanggal Mulai" }),
                    /* @__PURE__ */ jsxs("span", { className: "font-medium", children: [
                      format(new Date(data.start_date), "dd MMMM yyyy", { locale: id }),
                      data.start_time && /* @__PURE__ */ jsx("span", { className: "ml-2 text-xs bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded font-mono", children: data.start_time })
                    ] })
                  ] }),
                  data.end_date && data.type !== "atr" && /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-xs block", children: "Tanggal Selesai" }),
                    /* @__PURE__ */ jsxs("span", { className: "font-medium", children: [
                      format(new Date(data.end_date), "dd MMMM yyyy", { locale: id }),
                      data.end_time && /* @__PURE__ */ jsx("span", { className: "ml-2 text-xs bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded font-mono", children: data.end_time })
                    ] })
                  ] })
                ] })
              ] }),
              isRevisionStatus && isCreator && /* @__PURE__ */ jsxs("div", { className: "bg-orange-50/50 p-4 rounded-lg border border-orange-200 space-y-4", children: [
                ...
                revisionEditing && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                  ...
                  (data.type === "atr" || data.type === "eer") && /* @__PURE__ */ jsxs("div", { className: "space-y-4 pt-2 border-t mt-4", children: [
                    /* @__PURE__ */ jsx(Label, { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-wider", children: data.type === "eer" ? "Klaim Item EER" : "Item & Rincian Kegiatan ATR" }),
                    data.type === "eer" ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                      revisionForm.eer_items.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "border rounded-xl p-4 bg-white shadow-sm hover:shadow-md transition-shadow relative group", children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-3", children: [
                          /* @__PURE__ */ jsxs("div", { className: "md:col-span-12 lg:col-span-5 space-y-1", children: [
                            /* @__PURE__ */ jsxs(Label, { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500", children: [
                              "PILIH KEGIATAN ",
                              /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                            ] }),
                            /* @__PURE__ */ jsx(
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "md:col-span-12 lg:col-span-7 space-y-1", children: [
                            /* @__PURE__ */ jsxs(Label, { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500", children: [
                              "NAMA ITEM ",
                              /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                            ] }),
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "md:col-span-3 lg:col-span-2 space-y-1", children: [
                            /* @__PURE__ */ jsxs(Label, { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500", children: [
                              "QTY ",
                              /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                            ] }),
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "md:col-span-4 lg:col-span-3 space-y-1", children: [
                            /* @__PURE__ */ jsxs(Label, { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500", children: [
                              "HARGA SATUAN ",
                              /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                            ] }),
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "md:col-span-5 lg:col-span-4 space-y-1", children: [
                            /* @__PURE__ */ jsxs(Label, { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500", children: [
                              "JENIS BIAYA ",
                              /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                            ] }),
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "md:col-span-12 lg:col-span-3 space-y-1", children: [
                            /* @__PURE__ */ jsx(Label, { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500", children: "TOTAL" }),
                            /* @__PURE__ */ jsxs("div", { className: "h-8 bg-emerald-50 border border-emerald-100 rounded-md flex items-center px-3 font-bold text-emerald-800 text-xs", children: [
                              "Rp ",
                              item.amount.toLocaleString("id-ID")
                            ] })
                          ] }),
                          /* @__PURE__ */ jsxs("div", { className: "md:col-span-12 lg:col-span-6 space-y-1", children: [
                            /* @__PURE__ */ jsxs(Label, { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1", children: [
                            ...
                            /* @__PURE__ */ jsx(
                              FileUploadDropzone,
                              {
                                ...
                                onFilesChange: (files) => updateItemEerRevision(item.id, "receipt", files[0] ?? null)
                              }
                            ),
                            (item.receipt || item.receipt_path) && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-[10px] text-emerald-600 bg-emerald-50 p-1.5 rounded mt-1 border border-emerald-100 italic", children: [
                              /* @__PURE__ */ jsx(CheckCircle, { className: "h-3 w-3" }),
                              " ",
                              item.receipt ? `Baru: ${item.receipt.name}` : "Sudah terlampir"
                            ] })
                          ] }),
                          /* @__PURE__ */ jsxs("div", { className: "md:col-span-12 lg:col-span-6 space-y-1", children: [
                            /* @__PURE__ */ jsx(Label, { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500", children: "CATATAN TAMBAHAN" }),
                            /* @__PURE__ */ jsx(
                              Textarea,
                              {
                                value: item.notes,
                    ...
                    data.type === "eer" && /* @__PURE__ */ jsxs("div", { className: "mt-4 p-4 border rounded-xl bg-slate-50/50 space-y-4", children: [
                      /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                        /* @__PURE__ */ jsx(Label, { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-wider", children: "Tipe Hasil EER" }),
                        /* @__PURE__ */ jsxs(
                          RadioGroup,
                          {
                            value: revisionForm.eer_type,
                            onValueChange: (v) => setRevisionForm((p) => ({ ...p, eer_type: v })),
                            ...
                            children: [
                              /* @__PURE__ */ jsxs("div", { className: cn(
                                ...
                                /* @__PURE__ */ jsx(RadioGroupItem, { value: "refund", id: "rev-refund" }),
                                /* @__PURE__ */ jsx(Label, { htmlFor: "rev-refund", className: "text-xs cursor-pointer font-medium", children: "Refund" })
                              ] }),
                              /* @__PURE__ */ jsxs("div", { className: cn(
                                "flex items-center space-x-2 p-2 rounded-lg border bg-white cursor-pointer",
                                revisionForm.eer_type === "reimbursement" && "border-blue-500 bg-blue-50/30"
                              ), children: [
                                /* @__PURE__ */ jsx(RadioGroupItem, { value: "reimbursement", id: "rev-reimbursement" }),
                                /* @__PURE__ */ jsx(Label, { htmlFor: "rev-reimbursement", className: "text-xs cursor-pointer font-medium", children: "Reimbursement" })
                              ] })
                            ]
                          }
                        )
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                        /* @__PURE__ */ jsxs(Label, { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-wider", children: [
                          "Nominal ",
                          revisionForm.eer_type === "refund" ? "Refund" : "Reimburse"
                        ] }),
                        /* @__PURE__ */ jsx(
                          Textarea,
                          {
              ...
              data.type === "eer" && (() => {
                ...
                return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                  eerItems.length > 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                    /* @__PURE__ */ jsxs("label", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider flex items-center gap-2", children: [
                      ...
                      " Item Klaim EER (Aktual)"
                    ] }),
                    /* @__PURE__ */ jsx("div", { className: "border rounded-xl overflow-hidden shadow-sm bg-white", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
                      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b bg-slate-50/50", children: [
                        /* @__PURE__ */ jsx("th", { className: "text-left p-4 font-bold text-slate-600 text-[10px] uppercase tracking-wider", children: "Nama Item" }),
                        /* @__PURE__ */ jsx("th", { className: "text-left p-4 font-bold text-slate-600 text-[10px] uppercase tracking-wider", children: "Kegiatan" }),
                        /* @__PURE__ */ jsx("th", { className: "text-right p-4 font-bold text-slate-600 text-[10px] uppercase tracking-wider", children: "Nominal Klaim" }),
                        /* @__PURE__ */ jsx("th", { className: "text-left p-4 font-bold text-slate-600 text-[10px] uppercase tracking-wider", children: "Jenis" }),
                        /* @__PURE__ */ jsx("th", { className: "text-center p-4 font-bold text-slate-600 text-[10px] uppercase tracking-wider w-24", children: "Kwitansi" })
                      ] }) }),
                      /* @__PURE__ */ jsx("tbody", { children: eerItems.map((item) => /* @__PURE__ */ jsxs("tr", { className: "border-b last:border-0 hover:bg-slate-50/50 transition-colors", children: [
                        /* @__PURE__ */ jsx("td", { className: "p-4 font-semibold text-slate-900", children: item.item_name }),
                        /* @__PURE__ */ jsx("td", { className: "p-4 text-slate-500 font-medium", children: item.activity_name }),
                        /* @__PURE__ */ jsxs("td", { className: "p-4 text-right font-mono font-bold text-blue-700", children: [
                          "Rp ",
                          item.amount.toLocaleString("id-ID")
                        ] }),
                        /* @__PURE__ */ jsx("td", { className: "p-4", children: item.expense_type && /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: "text-[10px] h-5 bg-blue-50 text-blue-700 border-blue-100", children: item.expense_type }) }),
                        /* @__PURE__ */ jsx("td", { className: "p-4 text-center", children: item.receipt_path ? /* @__PURE__ */ jsx("a", { href: `/storage/${item.receipt_path}`, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsxs(Button, { size: "sm", variant: "outline", className: "h-7 px-2 text-[10px] gap-1 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200", children: [
                          /* @__PURE__ */ jsx(Download, { className: "h-3 w-3" }),
                          " Lihat"
                        ] }) }) : /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground italic", children: "—" }) })
                      ] }, item.id)) }),
                      /* @__PURE__ */ jsx("tfoot", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-slate-900 text-white", children: [
                        /* @__PURE__ */ jsx("td", { colSpan: 2, className: "p-4 text-right font-bold text-[10px] uppercase tracking-widest text-slate-400", children: "Total Klaim EER" }),
                        /* @__PURE__ */ jsxs("td", { className: "p-4 text-right font-mono font-black text-white text-base", children: [
                          "Rp ",
                          eerItems.reduce((s, i) => s + i.amount, 0).toLocaleString("id-ID")
                        ] }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 relative", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "bg-white p-4 rounded-lg border border-amber-100 shadow-sm relative z-10 flex flex-col gap-1", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-2", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-slate-800", children: format(new Date(data.start_date), "dd MMMM yyyy", { locale: id }) }),
                      data.start_time && /* @__PURE__ */ jsx("span", { className: "text-xs font-mono font-medium px-2 py-0.5 bg-amber-100 text-amber-800 rounded", children: data.start_time })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "bg-white p-4 rounded-lg border border-amber-100 shadow-sm relative z-10 flex flex-col gap-1", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-2", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-slate-800", children: format(new Date(data.end_date), "dd MMMM yyyy", { locale: id }) }),
                      data.end_time && /* @__PURE__ */ jsx("span", { className: "text-xs font-mono font-medium px-2 py-0.5 bg-amber-100 text-amber-800 rounded", children: data.end_time })
                    ] })
                  ] })
                ] })
              ] }),
              data.usage_plan && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-medium text-muted-foreground uppercase", children: "Keterangan / Rencana Penggunaan" }),
                /* @__PURE__ */ jsx("div", { className: "p-4 bg-muted/40 rounded-lg text-sm leading-relaxed border border-muted/60", children: data.usage_plan })
              ] }),
              ...
              (data.status === "submitted" || data.status === "request_fund") && (isFinanceOrAdmin || data.type === "allowance" && isHrOrAdmin) && /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 mt-4 pt-4 border-t", children: /* @__PURE__ */ jsxs(
                Button,
                {
                  onClick: () => setTransferDialogOpen(true),
              ...
              data.transfer_proof_path && /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-xs font-medium text-muted-foreground uppercase", children: data.eer_type === "refund" ? "Bukti Refund (User)" : "Bukti Transfer (Finance)" }),
                  /* @__PURE__ */ jsx(Badge, { variant: "outline", className: cn("text-xs", data.eer_type === "refund" ? "bg-emerald-50 text-emerald-700 border-emerald-200" : "bg-blue-50 text-blue-700 border-blue-200"), children: data.eer_type === "refund" ? "User" : "Finance" })
                ] }),
              ...
              data.type === "eer" && data.eer_type === "refund" && data.status !== "transferred" && /* @__PURE__ */ jsxs("div", { className: "bg-rose-50/50 p-4 rounded-lg border border-rose-100 space-y-3", children: [
          ...
          /* @__PURE__ */ jsxs(Card, { className: "shadow-sm", children: [
            ...
            /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
                ...
                data.comments.map((comment) => {
                  ...
                  return /* @__PURE__ */ jsxs("div", { className: `flex gap-3 ${isCreator2 ? "flex-row-reverse" : ""}`, children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: `flex flex-col gap-1 max-w-[80%] ${isCreator2 ? "items-end" : "items-start"}`, children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: `rounded-lg px-3 py-2 text-sm ${isCreator2 ? "bg-primary text-primary-foreground" : "bg-white border text-foreground"}`, children: comment.comment })
                    ] })
                  ] }, comment.id);
                }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-end pt-2", children: [
    ...
    /* @__PURE__ */ jsx(Dialog, { open: transferDialogOpen, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-4 py-4", children: !(data?.eer_type === "refund" && data?.transfer_proof_path) ? /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      ...
      ] }) : /* @__PURE__ */ jsxs("div", { className: "bg-emerald-50 p-4 rounded-lg border border-emerald-200 space-y-3", children: [
        ...
        /* @__PURE__ */ jsx("a", { href: `/storage/${data.transfer_proof_path}`, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", className: "w-full text-emerald-700 border-emerald-300 hover:bg-emerald-100", children: [
