...
import ProjectTabs from "./ProjectTabs-tfugzmTX.js";
...
import { Pencil, Trash2, Users, Handshake, ShieldCheck, User, Layers, Hash, CheckCircle2, Loader2, Plus, BarChart3, Calendar } from "lucide-react";
...
function ProjectsShow({ project_slug }) {
  ...
  return /* @__PURE__ */ jsxs(AppSidebarLayout, { breadcrumbs, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 p-4 md:p-8 pb-0", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-end md:items-center gap-2 w-full md:w-auto", children: [
        /* @__PURE__ */ jsx(StatusBadge, { status: currentStatus }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2 w-full md:w-auto", children: [
          /* @__PURE__ */ jsx(Link, { href: `/projects/${project.uuid}/edit`, className: "flex-1 md:flex-none", children: /* @__PURE__ */ jsxs(Button, { variant: "outline", className: "w-full gap-2", children: [
            /* @__PURE__ */ jsx(Pencil, { className: "h-4 w-4" }),
            "Edit Project"
          ] }) }),
          /* @__PURE__ */ jsx(Button, { variant: "destructive", size: "icon", onClick: () => setIsDeleteAlertOpen(true), title: "Hapus Proyek", children: /* @__PURE__ */ jsx(Trash2, { className: "h-4 w-4" }) })
        ] })
      ] })
    ] }),
