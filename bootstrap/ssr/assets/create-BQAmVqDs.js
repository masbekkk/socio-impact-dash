  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full lg:grid lg:grid-cols-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative hidden flex-col justify-between p-10 text-white lg:flex overflow-hidden bg-black", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-lg space-y-6", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-5xl font-bold leading-tight tracking-tight", children: "Make A Greatest and Sustainable Impact" }),
        /* @__PURE__ */ jsx("p", { className: "text-lg text-white/80", children: "Socialimpact.ID is a management consulting firm with expertise in Sustainability, Corporate Social Responsibility (CSR), Environmental, Social and Governance (ESG), and Community Involvement and Development (CID) programmes" })
      ] }),
