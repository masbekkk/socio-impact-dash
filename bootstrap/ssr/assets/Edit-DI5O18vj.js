...
function ProjectsEdit({ project_slug, divisions, employees, available_management_budget = 0 }) {
  const { props } = usePage();
  ...
  const [yearClaims, setYearClaims] = useState([]);
  const [deleteYearClaims, setDeleteYearClaims] = useState([]);
    ...
    const fetchProject = async () => {
      ...
      try {
        ...
        if (data.year_claims && data.year_claims.length > 0) {
          setYearClaims(data.year_claims.map((c) => ({
            id: c.id.toString(),
            year: c.year,
            amount: c.amount || 0
          })));
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "p-6 md:p-8 space-y-6", children: [
            /* @__PURE__ */ jsx("div", { className: "bg-gray-50 border rounded-xl p-6 md:p-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row gap-8 items-start justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-4 w-full", children: [
                ...
                formData.project_type === "non-project" && /* @__PURE__ */ jsxs("p", { className: `text-xs mt-2 ${budget > (available_management_budget || 0) ? "text-red-500 font-semibold" : "text-muted-foreground"}`, children: [
                  "Available Management Budget: ",
                  new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(available_management_budget || 0).replace("Rp", "Rp "),
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] italic", children: "Total nominal tidak boleh melebihi sisa management budget dari project lain." })
                ] })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "w-full md:w-[320px] shrink-0", children: /* @__PURE__ */ jsx("div", { className: "bg-white border rounded-xl p-6 shadow-sm text-center space-y-2", children: (() => {
                const isNonProject = formData.project_type === "non-project";
                return /* @__PURE__ */ jsxs(Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "pt-2 mt-2 border-t space-y-4 text-left", children: [
                    ...
                    !isNonProject && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "space-y-3", children: detailBudgets.map((detail, idx) => /* @__PURE__ */ jsxs("div", { className: "border rounded-xl p-3 bg-white shadow-sm flex items-center gap-3 group hover:border-gray-300 transition-colors", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1 grid grid-cols-1 md:grid-cols-12 gap-3 items-end", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 space-y-1", children: [
                    ...
                    ((detail.used_eer || 0) > 0 || (detail.used_atr || 0) > 0) && !detail.isNew ? /* @__PURE__ */ jsx("div", { className: "bg-gray-50 border rounded-md p-1.5 h-8 flex flex-col justify-center", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                      /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] font-semibold", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format((detail.used_eer || 0) > 0 ? detail.used_eer || 0 : detail.amount_pelaksanaan || 0) }),
                      /* @__PURE__ */ jsxs(Badge, { variant: "outline", className: `font-mono text-[8px] px-1 py-0 h-4 border-0 leading-tight ${(detail.used_atr || 0) - (detail.used_eer || 0) > 0 ? "text-green-600 bg-green-50" : (detail.used_atr || 0) - (detail.used_eer || 0) < 0 ? "text-red-600 bg-red-50" : "text-gray-500 bg-gray-50"}`, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4 pt-4 border-t mt-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx(Label, { className: "text-base font-semibold", children: "Tahun Anggaran" }),
                  /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
                    "Alokasi anggaran per tahun. Total tidak boleh melebihi Rp ",
                    budget.toLocaleString("id-ID"),
                    "."
                  ] }),
                  totalYearClaims > budget && /* @__PURE__ */ jsxs("p", { className: "text-xs text-red-500 mt-1 font-medium", children: [
                    "Total tahun anggaran (Rp ",
                    totalYearClaims.toLocaleString("id-ID"),
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                yearClaims.length === 0 && /* @__PURE__ */ jsx("div", { className: "text-center py-6 text-muted-foreground border rounded-md text-sm", children: 'Belum ada tahun anggaran. Klik "Tambah Tahun" untuk menambahkan.' }),
                yearClaims.map((claim) => {
                  ...
                  return /* @__PURE__ */ jsxs("div", { className: "border rounded-xl p-4 bg-white shadow-sm flex items-center gap-3 group hover:border-gray-300 transition-colors", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 items-end", children: [
                      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                        /* @__PURE__ */ jsx(Label, { className: "text-[10px] font-bold text-muted-foreground uppercase", children: "Tahun" }),
                        /* @__PURE__ */ jsx(
                          Input,
                          {
                            type: "number",
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                        /* @__PURE__ */ jsx(Label, { className: "text-[10px] font-bold text-muted-foreground uppercase", children: "Jumlah" }),
                        /* @__PURE__ */ jsx(
                          MoneyInput,
                          {
                            value: claim.amount,
                        ...
                        isOver && /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-red-500", children: [
                          "Maks: Rp ",
                          maxAllowed.toLocaleString("id-ID")
                        ] })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsx(
              ...
              /* @__PURE__ */ jsxs("div", { className: cn("border rounded-lg p-4 flex items-center justify-between", totalYearClaims > budget ? "bg-red-50 border-red-200" : "bg-blue-50 border-blue-200"), children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: cn("text-sm font-medium", totalYearClaims > budget ? "text-red-900" : "text-blue-900"), children: "Total Tahun Anggaran" }),
                  /* @__PURE__ */ jsxs("p", { className: cn("text-xs mt-0.5", totalYearClaims > budget ? "text-red-700" : "text-blue-700"), children: [
                    yearClaims.length,
                    " tahun"
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: cn("text-lg font-bold", totalYearClaims > budget ? "text-red-900" : "text-blue-900"), children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(totalYearClaims) }),
                  /* @__PURE__ */ jsxs("p", { className: cn("text-xs", totalYearClaims > budget ? "text-red-700 font-bold" : "text-blue-700"), children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4 pt-4 border-t mt-6", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "space-y-3", children: paymentTerms.map((term, idx) => /* @__PURE__ */ jsxs("div", { className: "border rounded-xl p-5 bg-white shadow-sm space-y-4 group hover:border-gray-300 transition-colors", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsx(Label, { className: "text-xs font-medium text-muted-foreground", children: "Nomor Surat" }),
                    /* @__PURE__ */ jsx(
                      Input,
                      {
                        type: "text",
                    ...
                    errors[`termin_payments.${idx}.nomor_surat`] && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 mt-1", children: errors[`termin_payments.${idx}.nomor_surat`] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsx(Label, { className: "text-xs font-medium text-muted-foreground", children: "Tertuju" }),
                    /* @__PURE__ */ jsx(
                      Input,
                      {
                        type: "text",
                    ...
                    errors[`termin_payments.${idx}.tertuju`] && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 mt-1", children: errors[`termin_payments.${idx}.tertuju`] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsx(Label, { className: "text-xs font-medium text-muted-foreground", children: "Dokumen Penagihan" }),
                    term.billing_document_url && !term.billing_file && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 p-2 bg-gray-50 border rounded-lg mb-2", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-gray-700 flex-1 truncate", children: "File Tagihan Saat Ini" }),
                      /* @__PURE__ */ jsx(
                        Button,
                        {
                          type: "button",
                    ...
                    term.billing_file && /* @__PURE__ */ jsxs("p", { className: "text-xs font-medium text-green-600 mt-2", children: [
                      "✓ Terpilih: ",
                      term.billing_file.name
                    ] }),
                    errors[`termin_payments.${idx}.billing_file`] && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 mt-1", children: errors[`termin_payments.${idx}.billing_file`] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsx(Label, { className: "text-xs font-medium text-muted-foreground", children: "Bukti Pembayaran" }),
                    term.proof_payment_url && !term.proof_file && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 p-2 bg-gray-50 border rounded-lg mb-2", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-gray-700 flex-1 truncate", children: "Bukti Pembayaran Saat Ini" }),
                      /* @__PURE__ */ jsx(
                        Button,
                        {
                          type: "button",
                    ...
                    term.proof_file && /* @__PURE__ */ jsxs("p", { className: "text-xs font-medium text-green-600 mt-2", children: [
                      "✓ Terpilih: ",
                      term.proof_file.name
                    ] }),
                    errors[`termin_payments.${idx}.proof_file`] && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 mt-1", children: errors[`termin_payments.${idx}.proof_file`] })
                  ] })
                ] })
              ] }, term.id)) }),
