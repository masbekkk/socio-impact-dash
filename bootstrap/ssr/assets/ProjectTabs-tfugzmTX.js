  ...
  return /* @__PURE__ */ jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "w-full", children: [
    ...
    /* @__PURE__ */ jsx(TabsContent, { value: "timeline", className: "mt-4", children: /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { className: "space-y-8", children: (() => {
        ...
        return /* @__PURE__ */ jsx("div", { className: "relative w-full overflow-x-auto pb-32 pt-32 px-4", children: /* @__PURE__ */ jsx("div", { className: "min-w-[900px] px-32", children: /* @__PURE__ */ jsxs("div", { className: "relative h-1.5 bg-slate-200 w-full rounded-full mt-12 mb-12", children: [
    ...
    /* @__PURE__ */ jsx(TabsContent, { value: "budget", className: "mt-4", children: /* @__PURE__ */ jsxs(Card, { className: "border shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "grid md:grid-cols-2 gap-6 pt-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-center", children: [
              canInputBudget && !editPartitions && /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", onClick: () => setEditPartitions(true), children: [
                /* @__PURE__ */ jsx(Pencil, { className: "w-4 h-4 mr-2" }),
                " Atur Anggaran"
              ] }),
              editPartitions && /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", onClick: () => setEditPartitions(false), disabled: savingBudget, children: "Batal" }),
                /* @__PURE__ */ jsx(Button, { size: "sm", onClick: handleSaveBudget, disabled: savingBudget, children: savingBudget ? /* @__PURE__ */ jsx(Loader, { className: "w-4 h-4 animate-spin" }) : "Simpan" })
              ] }),
              localBudgetStatus !== "approved" && canApproveBudget && /* @__PURE__ */ jsx(Button, { size: "sm", onClick: handleApproveBudget, disabled: savingBudget, className: "bg-green-600 hover:bg-green-700 text-white", children: savingBudget ? /* @__PURE__ */ jsx(Loader, { className: "w-4 h-4 animate-spin" }) : "Setujui Pembagian" })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-5 border rounded-xl bg-white shadow-sm space-y-1 hover:border-blue-200 transition-colors", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-4 pt-4 border-t border-slate-50 space-y-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground", children: "Terpakai ATR" }),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-slate-700", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", maximumFractionDigits: 0 }).format(project.used_atr || 0) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground", children: "Terpakai EER" }),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-slate-700", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", maximumFractionDigits: 0 }).format(project.used_eer || 0) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center bg-blue-50/50 p-1.5 rounded-md", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-blue-700", children: "Sisa Anggaran" }),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-blue-700", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", maximumFractionDigits: 0 }).format(project.remaining_operational || 0) })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-5 border rounded-xl bg-white shadow-sm space-y-1 hover:border-purple-200 transition-colors", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-5 border rounded-xl bg-white shadow-sm space-y-1 hover:border-amber-200 transition-colors", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-4 pt-4 border-t border-slate-50 space-y-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground", children: "Usage Allowance" }),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-slate-700", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", maximumFractionDigits: 0 }).format(project.used_allowance || 0) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center bg-amber-50/50 p-1.5 rounded-md", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-amber-700", children: "Sisa Allowance" }),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-amber-700", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", maximumFractionDigits: 0 }).format(project.remaining_allowance || 0) })
                ] })
              ] })
            ] })
          ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 pt-6 border-t mt-4", children: [
          ...
          !editDetailBudget ? /* @__PURE__ */ jsx("div", { className: "bg-white border rounded-xl shadow-sm overflow-hidden", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left", children: [
            /* @__PURE__ */ jsx("thead", { className: "bg-gray-50 border-b", children: /* @__PURE__ */ jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-medium text-gray-500 text-right", children: "Amount Pelaksanaan" }),
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-medium text-gray-500 text-right", children: "Selisih" }),
            ...
            /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-gray-100", children: [
              detailBudgets.length > 0 ? detailBudgets.map((detail, idx) => {
                ...
                return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-right font-mono", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(pelaksanaan) }),
                  /* @__PURE__ */ jsx("td", { className: `px-4 py-3 text-right font-mono font-semibold ${selisih >= 0 ? "text-green-700" : "text-red-600"}`, children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(selisih) }),
                  /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-muted-foreground", children: detail.notes || "-" })
                ] }, idx);
              }) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 6, className: "px-4 py-8 text-center text-muted-foreground italic", children: "Belum ada rincian anggaran." }) }),
              detailBudgets.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsxs("tr", { className: "bg-gray-50/80 font-semibold border-t-2", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: `px-4 py-3 text-right font-mono font-bold ${totalProposal - totalPelaksanaan >= 0 ? "text-green-700" : "text-red-600"}`, children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(totalProposal - totalPelaksanaan) }),
                  /* @__PURE__ */ jsx("td", {})
                ] }),
                /* @__PURE__ */ jsxs("tr", { className: "bg-emerald-50/80 border-t", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { colSpan: 4, className: `px-4 py-3 text-right font-mono text-lg font-bold ${estimasiProfit >= 0 ? "text-emerald-700" : "text-red-600"}`, children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(estimasiProfit) })
                ] })
              ] })
            ] })
          ] }) }) : /* @__PURE__ */ jsxs("div", { className: "border rounded-xl p-5 bg-gray-50/50 space-y-4", children: [
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: detailBudgets.map((detail, idx) => /* @__PURE__ */ jsxs("div", { className: "bg-white p-3 rounded-lg border shadow-sm flex items-center gap-3 group hover:border-blue-200 transition-colors", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-white border rounded-lg shadow-sm", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-muted-foreground uppercase", children: "Total Proposal" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-blue-600", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(detailBudgets.reduce((sum, item) => sum + (Number(item.amount_proposal) || 0), 0)) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-1 border-l pl-4", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-indigo-600", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(detailBudgets.reduce((sum, item) => sum + (Number(item.amount_pelaksanaan) || 0), 0)) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-1 border-l pl-4", children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4 border-t pt-6", children: [
        ...
        (() => {
          ...
          return terms.length > 0 ? /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-3 text-sm", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxs("p", { className: "font-bold text-gray-900 flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "font-medium text-gray-900", children: term.notes })
                    ] })
                  ] })
                ] }),
            ...
            /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5 mt-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-blue-900", children: "Total Termin Pembayaran" }),
                /* @__PURE__ */ jsxs("p", { className: "text-xs text-blue-700 mt-1", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-blue-900", children: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(
