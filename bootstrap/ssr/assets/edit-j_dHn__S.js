...
function Edit({ letterDivisiSuratId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response?.status === 422) {
        ...
        toast.error(error.response?.data?.message || "Gagal memperbarui divisi surat.");
      }
    }
  };
  const breadcrumbs = [
  ...
  return /* @__PURE__ */ jsxs(AppSidebarLayout, { breadcrumbs, children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Letter Divisi Suraton" }),
    /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-10 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Edit Letter Divisi Suraton" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Update divisi suraton details." })
        ] })
      ] }),
