...
function Create() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("/api/v1/divisions", data);
  ...
  return /* @__PURE__ */ jsxs(AppSidebarLayout, { breadcrumbs, children: [
    /* @__PURE__ */ jsx(Head, { title: "Add Division" }),
    /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-10 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Add Division" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Create a new division or department." })
        ] })
      ] }),
