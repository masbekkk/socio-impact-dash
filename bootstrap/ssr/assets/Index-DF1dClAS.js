  ...
  return /* @__PURE__ */ jsxs(AppSidebarLayout, { breadcrumbs, children: [
            ...
            Dialog,
            {
              ...
              children: /* @__PURE__ */ jsx(DialogContent, { className: "sm:max-w-[500px]", children: /* @__PURE__ */ jsxs("form", { onSubmit: submitForm, children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid gap-4 py-4", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
                    /* @__PURE__ */ jsx(Label, { htmlFor: "user_ids", children: "Undang Rekan Kerja (Opsional)" }),
                    /* @__PURE__ */ jsx(
                      SearchableMultiSelect,
                      {
                        ...
                        value: (data.user_ids || []).map((id2) => id2.toString()),
                        onValueChange: (vals) => setData(
                          "user_ids",
                    ...
                    errors.user_ids && /* @__PURE__ */ jsx("span", { className: "text-xs text-red-500", children: errors.user_ids })
                  ] }),
    ...
    /* @__PURE__ */ jsx(Dialog, { open: isDetailOpen, onOpenChange: setIsDetailOpen, children: /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-[425px]", children: [
      ...
      selectedEvent && /* @__PURE__ */ jsxs("div", { className: "grid gap-4 py-4", children: [
        ...
        selectedEvent.creator_name && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { className: "text-xs text-muted-foreground", children: "Dibuat Oleh" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm font-medium", children: selectedEvent.creator_name })
        ] }),
        selectedEvent.attendees && selectedEvent.attendees.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ jsxs(Label, { className: "text-xs text-muted-foreground", children: [
            "Undangan (",
            selectedEvent.attendees.length,
            ")"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1", children: selectedEvent.attendees.map((attendee) => /* @__PURE__ */ jsx(
            Badge,
            {
              variant: "outline",
