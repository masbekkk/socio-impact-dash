    ...
    /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-10 space-y-6", children: [
      ...
      /* @__PURE__ */ jsx(Card, { className: "border-none shadow-sm rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxs("form", { onSubmit: (e) => {
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 bg-white", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mb-6", children: "Pilih kegiatan dari proyek, lalu tambahkan item detail untuk kegiatan tersebut." }),
          selectedProject ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            availableActivities.length > 0 && selectedActivities.length === 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 bg-white", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: documents.map((doc, index) => /* @__PURE__ */ jsxs("div", { className: "border rounded-xl p-4 bg-slate-50/50 space-y-3 relative", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              ...
              doc.file ? /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-emerald-600 font-medium truncate mt-2", children: [
                "Terlampir: ",
                doc.file.name
              ] }) : doc.original_name ? /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-emerald-600 font-medium truncate mt-2", children: [
                "✓ Tersimpan: ",
                doc.original_name
              ] }) : null
            ] })
        ...
        /* @__PURE__ */ jsx(Separator, {}),
        /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 bg-white", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold mb-1", children: "Catatan Tambahan" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mb-6", children: "Tambahkan catatan tambahan, seperti jadwal pemakaian, dan tingkat urgensi." }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 bg-white", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "bank_branch", children: "Cabang Pembuka Rekening" }),
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx(Building2, { className: "absolute left-3 top-3 h-4 w-4 text-muted-foreground" }),
                /* @__PURE__ */ jsx(Input, { id: "bank_branch", name: "bank_branch", placeholder: "Contoh: KCP Sudirman", className: "pl-9 h-10", value: formData.bank_branch, onChange: handleChange })
              ] })
            ] })
          ] })
        ] }),
